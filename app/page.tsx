...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <section
        id="about-me"
        className="relative w-full h-screen flex items-center justify-center select-none"
      >
      ...
      <section
        id="contact-me"
        className="relative w-full h-screen flex items-center justify-center select-none pb-24"
      >
        <h2 className="text-5xl md:text-7xl font-black tracking-tighter text-black dark:text-white uppercase">
          Contact Me
        </h2>
